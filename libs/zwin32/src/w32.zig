...
pub extern "user32" fn GetWindowLongPtrA(hWnd: ?HWND, nIndex: INT) ?*anyopaque;

pub extern "user32" fn SetWindowLongPtrA(hWnd: ?HWND, nIndex: INT, dwNewLong: ?*anyopaque) LONG_PTR;
